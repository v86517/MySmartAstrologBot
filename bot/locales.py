...
TEXTS = {
    'ru': {
        ...
        'choose_timezone': "🕒 Выберите ваш часовой пояс для корректного времени автоотправки гороскопа в 08:00 (например: Москва - UTC+3, Владивосток - UTC+10):",
        ...
        'horoscope_basic_gender': '⚥ Пол',
        'horoscope_basic_birth_date': '📅 Дата рождения',
        'horoscope_basic_birth_time': '🕒 Время рождения',
        'horoscope_basic_birth_place': '📍 Место рождения',
        'horoscope_basic_sun': '☀️ Солнце',
        'horoscope_basic_moon': '🌙 Луна',
        'horoscope_basic_ascendant': '⬆️ Асцендент',
        'horoscope_basic_target_date': '📅 Дата',
        'horoscope_basic_target_weekday': '📆 День недели',
        'horoscope_basic_lunar_day': '🌙 Лунный день',
        'horoscope_basic_moon_illumination': '☀️ Освещённость Луны',
        ...
        'horoscope_period_choice': "Выберите период для гороскопа:",
        'horoscope_today': "📅 На сегодня",
        'horoscope_month': "📆 На этот месяц",
        'horoscope_year': "📅 На этот год",
...
# Для совместимости (заголовки)
        ...
        'astrology_payment_process': "💳 Оплата 999 ₽\n\nНажмите на кнопку ниже, чтобы перейти к оплате.\n\n⚠️ Оплата может занять до 1 минуты. После оплаты астрология будет доступна сразу по кнопке \"🌌 Натальная карта\".",
        ...
        'kb_cancel': "❌ Отмена",
        'kb_skip': "⏩ Пропустить",
        'kb_use_my_data': "👤 Использовать мои данные",
        'kb_fill_new': "✏️ Заполнить заново",
        'kb_confirm': "✅ Да, всё верно",
        'kb_edit': "✏️ Изменить",
        'kb_continue': "➡️ Продолжить",
        'kb_pay_888': "💳 Оплатить 888 ₽",
        'kb_pay_999': "💳 Оплатить 999 ₽",
        'kb_pay_333': "⭐ Оформить подписку 333 ₽",
        'kb_get_card': "✅ Получить карту",
        'kb_edit_data': "✏️ Изменить данные",
        'kb_get_analysis': "✅ Получить разбор",
        'kb_send_request': "📩 Отправить заявку эксперту",
        'kb_extend': "📅 Продлить подписку",
        'kb_save': "✅ Сохранить",
        'kb_dont_save': "❌ Не сохранять",
        'kb_refresh': "🔄 Обновить",
        'kb_main_menu': "🏠 Главное меню",
        'kb_edit_profile': "✏️ Изменить данные",
        'kb_change_timezone': "🕒 Сменить часовой пояс",
        'kb_cancel_subscription': "❌ Отменить подписку",
    ...
    'en': {
        ...
        'horoscope_basic_gender': '⚥ Gender',
        'horoscope_basic_birth_date': '📅 Date of birth',
        'horoscope_basic_birth_time': '🕒 Time of birth',
        'horoscope_basic_birth_place': '📍 Place of birth',
        'horoscope_basic_sun': '☀️ Sun',
        'horoscope_basic_moon': '🌙 Moon',
        'horoscope_basic_ascendant': '⬆️ Ascendant',
        'horoscope_basic_target_date': '📅 Date',
        'horoscope_basic_target_weekday': '📆 Day of week',
        'horoscope_basic_lunar_day': '🌙 Lunar day',
        'horoscope_basic_moon_illumination': '☀️ Moon illumination',
        ...
        'horoscope_period_choice': "Choose the period for your horoscope:",
        'horoscope_today': "📅 Today",
        ...
        'astrology_payment_process': "💳 Payment 999 ₽\n\nClick the button below to proceed to payment.\n\n⚠️ Payment may take up to 1 minute. After payment, astrology will be available immediately via the \"🌌 Natal chart\" button.",
        ...
        'kb_cancel': "❌ Cancel",
        'kb_skip': "⏩ Skip",
        'kb_use_my_data': "👤 Use my data",
        'kb_fill_new': "✏️ Fill in again",
        'kb_confirm': "✅ Yes, that's right",
        'kb_edit': "✏️ Edit",
        'kb_continue': "➡️ Continue",
        'kb_pay_888': "💳 Pay 888 ₽",
        'kb_pay_999': "💳 Pay 999 ₽",
        'kb_pay_333': "⭐ Subscribe 333 ₽",
        'kb_get_card': "✅ Get card",
        'kb_edit_data': "✏️ Edit data",
        'kb_get_analysis': "✅ Get analysis",
        'kb_send_request': "📩 Send request to expert",
        'kb_extend': "📅 Extend subscription",
        'kb_save': "✅ Save",
        'kb_dont_save': "❌ Don't save",
        'kb_refresh': "🔄 Refresh",
        'kb_main_menu': "🏠 Main menu",
        'kb_edit_profile': "✏️ Edit data",
        'kb_change_timezone': "🕒 Change timezone",
        'kb_cancel_subscription': "❌ Cancel subscription",
        'kb_support': "🆘 Support",
